...
if CupsTotals.count == 0
    CupsTotal.create(coffee_cups_total: 0, reusable_cups_total: 0, user_daily_id: 1)
    CupsTotal.create(coffee_cups_total: 0, reusable_cups_total: 0, user_daily_id: 2)
    CupsTotal.create(coffee_cups_total: 0, reusable_cups_total: 0, user_daily_id: 3)
end

if TravelTotal.count == 0 
    TravelTotal.create(walk_total: 0, pt_total_km: 0, drive_total_km: 0, user_daily_id: 1)
    TravelTotal.create(walk_total: 0, pt_total_km: 0, drive_total_km: 0, user_daily_id: 2)
    TravelTotal.create(walk_total: 0, pt_total_km: 0, drive_total_km: 0, user_daily_id: 3)
end

if UserDaily.count == 0
    UserDaily.create(user_id: 1, walk: true, public_transport: false, drive: false, coffee_cups: 5, reusable_cups: 0)
    UserDaily.create(user_id: 2, walk: false, public_transport: true, drive: false, coffee_cups: 2, reusable_cups: 3)
    UserDaily.create(user_id: 3, walk: false, public_transport: false, drive: true, coffee_cups: 0, reusable_cups: 8)
    UserDaily.create(user_id: 1, walk: false, public_transport: false, drive: true, coffee_cups: 5, reusable_cups: 0)
    UserDaily.create(user_id: 2, walk: true, public_transport: false, drive: false, coffee_cups: 2, reusable_cups: 3)
    UserDaily.create(user_id: 3, walk: false, public_transport: true, drive: false, coffee_cups: 0, reusable_cups: 8)
end
